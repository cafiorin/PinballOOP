...
//-----------------------------------------------------------
Stage3::Stage3(PinballMaster *pinball,uint8_t number):StageBase(pinball,number)
//-----------------------------------------------------------
{
...
//-----------------------------------------------------------
uint8_t Stage3::PlayfieldEvent(PinballObject *sender, uint8_t event, uint8_t valueToSend)
//-----------------------------------------------------------
{
	#ifdef DEBUGMESSAGES
